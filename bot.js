...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`BoT Script By : Awsiq1001`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers ' Awsiq1001 ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`$bc |CREATED BY Awsiq1001`,"playing")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setURL(https://discord.com/api/oauth2/authorize?client_id=750666203449786409&permissions=8&scope=bot`);
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            .setColor("RANDOM")
            .setThumbnail(message.author.avatarURL)
            .setDescription(`**__برودكاست بوت __ 
            ...
            رابط سيرفر صانع البوت : https://discord.gg/XnHmwec
            **`);
